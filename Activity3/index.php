  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="p2">Welcome About Us</div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="t2">Welcome About Us</div>
        ...
        <div class="panel-group" id="myaccordion">
            ...
            <div class="panel panel-danger">
                ...
                <div class="collapse panel-collapse" id="collap2">
                    <div class="panel-body"><img src="/3BSCS-2/studpic.jpg"></div>
                </div>
    ...
    <div class="container-fluid">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item">
                ...
                <div class="list-group-item-text">This is the paragrapgh</div>
            </a>
    ...
    <div class="container">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel panel-heading"><h4><a href="#abc" data-toggle="collapse">This is a panel heading</a></h4></div>
                <div id="abc" class="collapse panel-collapse collapse">
                <div class="panel-body"><p>This is a panel body</p></div>
                <div class="panel-footer">This is a panel footer</div>
            </div>
    ...
    <div class="container">
        ...
        <div id="dtx" class="collapse"><img src="/3BSCS-2/studpic.jpg"></div>
    ...
    <div class="container">
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel panel-heading"><h4>This is a panel heading</h4></div>
            <div class="panel-body"><p>This is a panel body</p></div>
            <div class="panel-footer">This is a panel footer</div>
