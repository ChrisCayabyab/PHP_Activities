        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <div class="radio">
                        <label type="radio" name="gender"><input type="checkbox">Male</label>
                    </div>

                    <div class="radio">
                        <label type="radio" name="gender"><input type="checkbox">Female</label>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <div class="radio">
                        <label type="radio-inline" name="gender"><input type="checkbox">Male</label>
                        <label type="radio-inline" name="gender"><input type="checkbox">Female</label>
