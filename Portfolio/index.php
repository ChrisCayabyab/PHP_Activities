...
<body data-spy="scroll" data-target=".navbar">
    ...
    <section id="home" style="background: url(/Portfolio/pic/header.jpg); background-size: 100% 100%;" class="cl_white text-center">
        <h1>My Portfolio</h1>
    ...
    <section id="work" class="container">
        <div class="page-header">
            ...
            <div class="text-center">
                <img src="/Portfolio/pic/port1.jpg" class="img-thumbnail" />
                <img src="/Portfolio/pic/port2.jpg" class="img-thumbnail" />
                <img src="/Portfolio/pic/port3.jpg" class="img-thumbnail" />
                <img src="/Portfolio/pic/port4.jpg" class="img-thumbnail" />
                <img src="/Portfolio/pic/port5.jpg" class="img-thumbnail" />
                <img src="/Portfolio/pic/port6.jpg" class="img-thumbnail" />
            </div>
        </div>
    </section>
